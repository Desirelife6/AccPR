...
class Pipeline:
    ...
    def parse_source(self, output_file, option):
        ...
        source = pd.read_pickle('all_words_embedding/all_words.pkl')
        self.sources = source
        return source
    ...
    def dictionary_and_embedding(self, input_file, size):
        ...
        w2v.save(self.w2v_path + 'all_words_w2v_30000')
...
ppl = Pipeline('3:1:1', 'all_words_embedding/', w2v_path='all_words_embedding/')
ppl.run()
